...
RCT_EXPORT_METHOD(send:(NSString*)eventType name:(NSString*)name args:(NSDictionary*)args){
  [NewRelicAgent recordCustomEvent:eventType name:name attributes:args];
}
